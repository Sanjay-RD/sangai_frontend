          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="p-4">
              <div className="mb-4">
                ...
                <input
                  className="shadow-none border rounded-full w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                  type="text"
                />
              </div>
              <div className="mb-4">
              ...
              <div className="mb-4">
                ...
                <div class="flex flex-row h-14 w-full">
                  <button
                    class=" bg-white text-gray-600 hover:text-gray-700 hover:bg-gray-400 h-full w-20 rounded-full cursor-pointer outline-double mx-2"
                  ...
                  <input
                    type="number"
                    class="focus:outline-none text-center w-full bg-white font-semibold text-xl hover:text-black focus:text-black  md:text-basecursor-default flex items-center text-gray-700  outline-none mx-2"
                    value={passenger}
                    name="passenger"
                  ></input>
                  <button
                    class="bg-white text-gray-600 hover:text-gray-700 hover:bg-gray-400 h-full w-20 rounded-full cursor-pointer outline-double"
